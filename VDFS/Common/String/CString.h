...
namespace Common {
  ...
  public:
    ...
    virtual bool32 IsA() const { return True; };
    virtual bool32 IsW() const { return False; };
    ...
    bool32 CompareMasked( const CStringA& str ) const;
    bool32 CompareMaskedI( const CStringA& str ) const;
    ...
    bool32 StartWith( const CStringA& cmp )  const;
    bool32 EndWith( const CStringA& cmp )  const;
    ...
    CStringA& Upper();
    CStringA GetUpper() const;
    CStringA& Lower();
    CStringA& LowerFirstUpper();
    CStringA Completion( const CStringA& end, const bool& ignoreEmpty = true ) const;
    CStringA Completion( const char& end, const bool& ignoreEmpty = true ) const;
    ...
    bool32 WriteToFileUTF8( const CStringA& fname, const bool32& createDirs = True ) const;
    ...
    bool32 AsFileExists( const int& accessMode = 0 ) const;
    CStringA GetFileName() const;
    CStringA GetDirectoryName() const;
    CStringA GetDirectory() const;
    CStringA GetExtension() const;
    CStringA RemoveExtension() const;
    CStringA GetFullPath() const;

    static CStringA Hex32( const uint32& val );
    static CStringA Hex64( const uint64& val );
    static CStringA Combine( const text format ... );

    static inline CStringA Hex32( void* val ) { return Hex32( (uint)val ); }
  ...
  public:
    ...
    virtual bool32 IsA() const { return False; };
    virtual bool32 IsW() const { return True; };
    ...
    bool32 CompareMasked( const CStringW& str ) const;
    bool32 CompareMaskedI( const CStringW& str ) const;
    ...
    bool32 StartWith( const CStringW& cmp ) const;
    bool32 EndWith( const CStringW& cmp ) const;
    ...
    bool32 WriteToFile( const CStringW& fname, const uint32& srcCodePage, const bool32& createDirs = True ) const;
    bool32 WriteToFile( const CStringW& fname, const bool32& createDirs = True ) const;
    bool32 WriteToFile( const CStringA& fname, const bool32& createDirs = True ) const;
    bool32 WriteToFileUTF8( const CStringW& fname, const bool32& createDirs = True ) const;
    bool32 ReadFromFile( const CStringW& fname, const uint32& srcCodePage );
    bool32 ReadFromFile( const CStringW& fname );
    bool32 ReadFromFile( const CStringA& fname );
    bool32 ReadFromVdf( const CStringW& fname, const long32& flags, const uint32& srcCodePage );
  ...
  struct ASTAPI UTF8Char {
    ...
    static uint CharSize( wchar_t uni16 );
  protected:
    uint LengthByOctets();
  };
  ...
  public:
    ...
    bool32 WriteToFile( CStringA fileName, const ELineBreak& lb = LB_CRLF );
    bool32 WriteToFile( CStringW fileName, const ELineBreak& lb = LB_CRLF );
    bool32 ReadFromFile( CStringA fileName );
    bool32 ReadFromFile( CStringW fileName, const uint32& srcCodePage = ANSI_CODEPAGE_DEFAULT );
    bool32 ReadFromVdf( CStringA fileName, const long& flags );
    bool32 ReadFromVdf( CStringW fileName, const long& flags, const uint32& srcCodePage = ANSI_CODEPAGE_DEFAULT );
  };
